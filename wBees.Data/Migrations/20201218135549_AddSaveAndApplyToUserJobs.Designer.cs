...
namespace wBees.Data.Migrations
{
    ...
    [Migration("20201218135549_AddSaveAndApplyToUserJobs")]
    partial class AddSaveAndApplyToUserJobs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("wBees.Data.Models.UserJobs", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("wBees.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("wBees.Data.Models.Job", b =>
                {
                    ...
                    b.HasOne("wBees.Data.Models.ApplicationUser", "PublishedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("wBees.Data.Models.UserJobs", b =>
                {
                    ...
                    b.HasOne("wBees.Data.Models.ApplicationUser", "User")
                        .WithMany("UserJobs")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
